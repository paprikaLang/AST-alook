...
HelloParser::WelcomeContext::WelcomeContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* HelloParser::WelcomeContext::ID() {
  return getToken(HelloParser::ID, 0);
}


size_t HelloParser::WelcomeContext::getRuleIndex() const {
  return HelloParser::RuleWelcome;
}

void HelloParser::WelcomeContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<HelloListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterWelcome(this);
}

void HelloParser::WelcomeContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<HelloListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitWelcome(this);
}


antlrcpp::Any HelloParser::WelcomeContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<HelloVisitor*>(visitor))
    return parserVisitor->visitWelcome(this);
  else
    return visitor->visitChildren(this);
}

HelloParser::WelcomeContext* HelloParser::welcome() {
  WelcomeContext *_localctx = _tracker.createInstance<WelcomeContext>(_ctx, getState());
  enterRule(_localctx, 0, HelloParser::RuleWelcome);
