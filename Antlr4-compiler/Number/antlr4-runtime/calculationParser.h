...
class  calculationParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleExpression = 2
  };

  calculationParser(antlr4::TokenStream *input);
  ~calculationParser();
  ...
  class  ResultContext : public ExpressionContext {
  public:
    ResultContext(ExpressionContext *ctx);
  ...
  class  IdenContext : public ExpressionContext {
  public:
    IdenContext(ExpressionContext *ctx);
